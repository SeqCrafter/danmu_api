                ...
                <div class="api-selector">
                    <div class="form-group">
                        ...
                        <select id="api-select" onchange="loadApiParams()">
                            ...
                            <option value="getCommentByUrl">从URL获取弹幕 - /api/v2/comment?url=videoUrl&format=json</option>
                            <option value="getAnimeByDouban">从豆瓣ID获取弹幕 - /api/v2/douban?douban_id=doubanId&episode_number=episodeNumber</option>
